...
RSpec.describe InheritedSettingsForKey do
  describe "#required_locales" do
    ...
    it "returns Article's required locales for Article-based Keys" do
      ...
      key = FactoryBot.create(:key, article: article, project: project)
  ...
  describe "#skip_key?" do
    it "calls's project's skip_key? method if key is git-based" do
      ...
      key = FactoryBot.create(:key, project: project, article: nil)
  ...
  describe "#base_locale" do
    ...
    it "returns Article's base locale for Article-based Keys" do
      project = FactoryBot.create(:project, base_rfc5646_locale: 'fr')
      article = FactoryBot.create(:article, project: project, base_rfc5646_locale: 'ja')
      key = FactoryBot.create(:key, article: article, project: project)
