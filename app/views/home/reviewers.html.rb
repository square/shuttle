...
module Views
  module Home
    class Reviewers < Views::Layouts::Application
      protected

      def body_content
        article(class: 'container') do
          page_header 'Review Translations'
      ...
      def locale_field
        form(id: 'locale') do
          input name: 'locale', type: 'text', class: 'locale-field', placeholder: 'type a locale here', id: 'locale-field'
