      ...
      def body_content
        ...
        article(class: 'container') do
          ...
          page_header do
            ...
            button class: 'btn page-header-btn', disabled: 'disabled', :'data-target'=>'#settings-modal', :'data-toggle'=>'modal' do
              i class: 'icon-cog'
            end
            button "Add New Term", class: "btn btn-success page-header-btn", :'data-target'=>'#add-entry-modal', :'data-toggle'=>'modal'
          end
          ########################
        ...
        div id: 'settings-modal', class: 'modal hide fade', tabindex: '-1', role: 'dialog', :'aria-labelledby' => 'myModalLabel', :'aria-hidden' => 'true' do
          ...
          div class: 'modal-body' do
            ...
            div class: 'control-group' do
              label 'Add Locale', class: 'control-label'
              div class: 'controls' do
                div do
                  input type: 'text', class: 'locale-field',
                    autocomplete: 'off', placeholder: 'Target Language'
                  button "Add Locale", class: 'btn', type: 'btn'
                end
            ...
            div class: 'control-group' do
              label 'Target Locales', class: 'control-label'
              div class: 'controls' do
